...
def val(batch_manager, model, discr, w_discr, logger=None, epoch=0):
    ...
    for i, (inputs_model, targets_model, _) in enumerate(loader):
        ...
        # Model forward.
        outputs_model, inputs_discr = model.model(Variable(inputs_model, volatile=True))
        ...
        loss_discr = discr.criterion(outputs_discr, Variable(targets_discr, volatile=True))
